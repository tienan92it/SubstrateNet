...
export const DEFAULT_CONFIG: SubstrateNetConfig = {
  ...
  agents: {
    ...
    triageBatch:    { model: 'openrouter:google/gemini-3.5-flash', fallback: 'default:llama3.1:8b', windowTokens: 2000 },
    ...
    clustererBatch: { model: 'openrouter:google/gemini-3.5-flash', fallback: 'default:llama3.1:8b' },
    ...
    sourceClassifierBatch: { model: 'frontier:composer-2.5', fallback: ['openrouter:google/gemini-3.5-flash', 'default:llama3.1:8b'] },
    ...
    knowledgeOrganizer: { model: 'frontier:composer-2.5', fallback: ['openrouter:google/gemini-3.5-flash', 'default:llama3.1:8b'] },
  },
  concurrency: 4,
  batchSize: 8,
  research: { kind: 'none' },
